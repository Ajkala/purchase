...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖 Updates', url='https://t.me/+pihWAHWUSMFkZmNl')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('Channel 👀', url='https://t.me/+JxQ6coHkUDIwY2M9'),
                    InlineKeyboardButton('Group 👀', url='https://t.me/+XDeQ9s4UdPYyZDc1')
                ],[
